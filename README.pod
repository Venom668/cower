...
B<Warning:> cower is no longer actively developed and has several unpleasant
bugs and corner cases that will never be fixed. Users are B<strongly>
encouraged to migrate to L<https://github.com/falconindy/auracle> as soon as
humanly possible.
